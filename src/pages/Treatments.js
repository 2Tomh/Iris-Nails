    ...
    return (
        ...
        <div className={styles.container}>
            ...
            <form className={styles.form}>
                <FormGroup className={styles.formContainer} open={props.open}  >
                ...
                <Button variant="outlined" onClick={nextStep} sx={{ borderRadius: '17px', width: '300px', color:"black" }} disabled={!menicure && !mustache && !eyebrow && !pedicure}>אישור</Button>
                </FormGroup>
            </form>
